...
d3.gantt = function() {
    ...
    var initTimeDomain = function() {
        // possiblity to set minDate and maxDate
        if(maxDate || minDate){
            if(maxDate){
                timeDomainEnd = maxDate;
            }
            if(minDate){
                timeDomainStart = minDate;
            }
        }else 
  ...
  */
    ...
    */
    ...
    gantt.orientation = function(value) {
        if (!arguments.length)
            return orientation;
        orientation = value;
        return gantt;
